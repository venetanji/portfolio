...
summary: A unique installation that uses fruit as the interface for generative
  music. Touch a piece of fruit, hear a sound — capacitive sensing, Arduino,
  Max/MSP and Ableton Live wired together.
draft: false
featured: false
weight: 1
links:
